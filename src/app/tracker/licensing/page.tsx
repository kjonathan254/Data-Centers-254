        ...
        <div className="container-site">
          ...
          <div className="mt-10 grid grid-cols-2 gap-3 sm:gap-4 lg:grid-cols-4">
            {[
              ...
              { icon: Shield, label: "Dataset verified", value: "Sep 2026", hint: "against the CA's own document" },
            ].map((s) => {
              const Icon = s.icon;
              return (
          ...
          <section aria-labelledby="timeline" className="mt-16">
            ...
            <ol className="mt-6 space-y-3">
              {[
                ...
                { when: "FY2026/27", what: "Consultation, finalisation of the framework and the consequential revision of the telecommunications market structure (the consultation document's roadmap table places the revision in this financial year, correcting earlier press reports that put it in FY2027/28)." },
                { when: "FY2027/28", what: "Implementation of the licensing framework, with facilities migrating to the new category. Transition mechanics (migration, renewal, fee harmonisation) settle in this window." },
              ].map((t) => (
          ...
          <section aria-labelledby="lsrc" className="mt-16">
            <div className="card-solid rounded-xl p-5 sm:p-6">
              ...
              <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                ...
                . Verified {LICENSING_LAST_VERIFIED} against the regulator's consultation document (captured in full) and independent outlets.
              </p>
            </div>
          </section>
        </div>
