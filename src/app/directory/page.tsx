...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://datacentre254.com/directory" },
  openGraph: {
    title: "DC Directory | Data Centre 254",
    description:
      "Kenya's most comprehensive data centre directory. Search, filter, and compare facilities. Every claim sourced and verified.",
...
// Server-rendered summary for SEO/crawlers
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        {/* Server-rendered content for crawlers — visually hidden, but indexed */}
        {facilities.length > 0 && (
