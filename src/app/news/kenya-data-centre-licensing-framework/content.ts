export const ARTICLE_META = {
  ...
  tlDr: "For the first time in Kenya's regulatory history, commercial data centres are explicitly licensed. The CA's NFP-T2 tier (KES 15M initial, 15-year term) is the primary route for data centre operators, while NFP-T1 covers integrated nationwide operators with spectrum rights.",
  cluster: "Kenya" as const,
  readingTimeMin: 12,
  publishedDate: "2026-08-21",
  author: "Data Centre 254 Editorial",
  slug: "kenya-data-centre-licensing-framework",
};

export const ARTICLE_CONTENT = `## The Regulatory Shift
