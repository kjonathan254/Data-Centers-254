...
const facilities: Facility[] = [
  // ── iXAfrica ──────────────────────────────────────────────────────────
  {
    ...
    sources: [
      ...
      { label: "iXAfrica, OCI Nairobi announcement (27 Jan 2026)", url: "https://ixafrica.co.ke/", kind: "operator" },
  ...
  // ── Nxtra by Airtel Tatu City (under construction) ──────────────────────
  {
    ...
    dataConfidence: "Medium",
    articleSlugs: ["kenya-data-centre-compute-hub-plan-explained"],
    operatorId: "nxtra",
    ...
    sources: [
      ...
      { label: "Eng. John K. Tanui (PS ICT and Digital Economy), Positioning Kenya as Africa's Preferred Data-Centre and Compute Hub (15 Sep 2026; 44 MW in two phases, commissioning targeted 2027)", url: "https://www.linkedin.com/pulse/positioning-kenya-africas-preferred-data-centre-hub-tanui-cbs-ic3jf", kind: "gov" },
      { label: "DataCenterDynamics, Nxtra Kenya coverage (groundbreaking reported 12 Sep 2025; US$150M)", url: "https://www.datacenterdynamics.com/en/search/?q=Nxtra+Kenya", kind: "press" },
    ],
    carrierNeutral: undefined,
    certNote: null,
