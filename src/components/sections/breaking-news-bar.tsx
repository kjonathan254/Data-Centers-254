...
import { breakingNews } from "@/lib/breaking";
 ...
 * Renders nothing when breakingNews is null. Server component.
 */
export default function BreakingNewsBar() {
  ...
  return (
    <section aria-label="Breaking news" className="border-b border-border/40 bg-card">
      <Link href={breakingNews.href} className="group block transition-colors hover:bg-background">
