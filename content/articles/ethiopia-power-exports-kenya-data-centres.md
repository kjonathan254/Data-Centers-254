---
title: "Ethiopia Power Exports and Kenya Data Centres"
slug: "ethiopia-power-exports-kenya-data-centres"
meta_description: "Ethiopia plans to double electricity exports to Kenya. What 400 MW of regional power could mean for data-centre capacity, cost and reliability."
primary_keyword: "Ethiopia power exports Kenya data centres"
secondary_keywords:
  - "Ethiopia Kenya electricity interconnector"
  - "Kenya data centre power reliability"
  - "East Africa regional power market"
  - "Kenya electricity imports"
  - "data centre energy Kenya"
...
images:
  - src: "/images/kenya-transmission-pylons-5.webp"
    alt: "High-voltage transmission pylons carrying electricity across Kenya"
    caption: "Regional power trade only becomes useful to digital infrastructure when generation, transmission, substations and local distribution all work together."
    position: "hero"
  - src: "/images/ethiopia-kenya-500kv-route-map.webp"
    alt: "Map of the 500 kV transmission line route from southern Ethiopia through Moyale to Suswa in Kenya"
    caption: "The route of the 500 kV Ethiopia-Kenya HVDC line: from Wolayta Sodo in southern Ethiopia, across the border at Moyale, then through Turbi, Marsabit and Laisamis before terminating near Naivasha and Gilgil in Kenya. The 200 MW now supplied and the 400 MW planned run well inside the line's 2,000 MW transfer capacity."
    position: "diagram"
  - src: "/images/diagram-power-chain-grid-to-gpu.webp"
    alt: "Diagram showing the power chain from electricity grid to GPU rack"
    caption: "Imported electricity enters Kenya's grid. A data centre still needs its own engineered path through switchgear, UPS systems, backup generation and rack-level distribution."
    position: "diagram"
  ...
  - src: "/images/diagram-grid-connection-anatomy.webp"
    ...
    caption: "What a connection actually consists of: a high-voltage substation and transformer, medium-voltage switchgear, distribution transformation and often reactive compensation or battery storage before power reaches a data centre. Imports add energy to the bulk system; they do not create capacity at any specific site on their own."
    position: "diagram"
  - src: "/images/gerd-dam-dusk.webp"
    alt: "The Grand Ethiopian Renaissance Dam on the Blue Nile photographed at dusk"
    caption: "The Grand Ethiopian Renaissance Dam at dusk. Inaugurated on 9 September 2025, the 5,150 MW plant anchors the hydro-dominated system behind the export programme, and Ethiopia has made selling surplus electricity to its neighbours an explicit national strategy."
    position: "section-break"
  - src: "/images/suswa-hvdc-converter-station.webp"
    alt: "Capacitor stacks and valve equipment at the Suswa HVDC converter station in Kenya"
    caption: "Conversion equipment at the Kenyan end of the line. HVDC imports arrive as direct current and must be converted back to alternating current before they enter Kenya's grid, which makes the converter station the most critical single node on the corridor, and its testing programme the announcement's real gate."
    position: "inline"
  - src: "/images/dc-switchgear-2.webp"
    alt: "Electrical switchgear cabinets inside a data centre power room"
    caption: "The grid supplies a data centre, but the facility's power design determines whether customers experience a disturbance."
    position: "inline"
  - src: "/images/ethiopia-kenya-power-line-corridor.webp"
    alt: "A corridor of high-voltage transmission towers running through hills toward the Ethiopian border"
    caption: "A corridor of high-voltage towers running toward the Ethiopian border. The Eastern Electricity Highway is the physical backbone of a wider Eastern Africa integration project that now spans generation, transmission and emerging market rules."
    position: "section-break"
  - src: "/images/gerd-powerhouse-ethiopian-flag.webp"
    alt: "Engineers operating switchgear inside the GERD powerhouse beneath a large Ethiopian flag"
    caption: "Exports are dispatched from control and switchgear rooms like this one inside the GERD powerhouse. The commercial rules matter as much as the hardware: volumes, tariffs and settlement arrangements are what turn installed capacity into dependable trade."
    position: "inline"
  - src: "/images/diagram-datacentre-power-microgrid.webp"
    alt: "Schematic of a data centre microgrid combining grid supply, on-site generation and battery storage"
    caption: "The supply stack a facility actually engineers: grid supply, on-site generation and storage coordinated behind its switchgear. Kenyan data centres design for the grid's worst day, whether the electrons arrive from Olkaria's steam fields or a converter station in the Rift Valley."
    position: "diagram"
internal_links:
  - text: "why power reliability shapes Kenya's data centres"
    href: "/articles/kenya-power-reliability-data-centres"
  - text: "Kenya's power infrastructure constraint for data centres"
    href: "/articles/kenya-power-infrastructure-data-centres"
  - text: "why geothermal energy matters to Kenyan data centres"
...
external_sources:
  ...
  - title: "African Development Bank, Ethiopia-Kenya Power Interconnector project information (1,045 km, 500 kV HVDC interconnector with up to 2,000 MW transfer capacity)"
    url: "https://www.afdb.org/en/topics-and-sectors/initiatives-partnerships/ethiopia-kenya-electricity-highway-project"
  - title: "African Development Bank, Ethiopia-Kenya electricity trade results (2024; 635 GWh of thermal generation displaced in the assessed six-month period)"
    url: "https://www.afdb.org/en/news-and-events/press-releases"
  - title: "Business Daily, analysis of Kenya Power supply data (August 2026; imports from Ethiopia and Uganda and spinning-reserve reporting)"
    url: "https://www.businessdailyafrica.com/"
  - title: "KETRACO, regional interconnector project information"
    url: "https://www.ketraco.co.ke/"
  - title: "World Bank, Eastern Africa Regional Electricity Access and Transmission Program approval (June 2026; $1.6 billion programme)"
    url: "https://www.worldbank.org/en/news/press-release/2026/06"
  - title: "The Reporter, Ethiopia-Tanzania electricity-trade trial reporting (19 September 2026; commercial terms and transmission arrangements still under discussion)"
    url: "https://www.thereporterethiopia.com/"
faq:
  - question: "Will Ethiopia's additional electricity supply power Kenya's data centres directly?"
    answer: "No. The planned additional supply enters Kenya's interconnected grid and serves the wider electricity system. It is not a dedicated allocation for data centres. Any benefit to a facility depends on local connection capacity, transmission, tariffs, contract terms and the facility's own redundancy design."
  - question: "Does importing 400 MW make Kenya's grid reliable enough for data centres?"
    answer: "Not by itself. More supply can help system adequacy, but data-centre reliability also depends on grid stability, the strength of transmission and distribution at the site, dual utility feeds, UPS systems, generators, fuel logistics and tested operating procedures."
  - question: "Could Ethiopian imports reduce data-centre electricity prices in Kenya?"
    answer: "They could improve system economics if lower-cost generation is delivered efficiently, but there is no automatic pass-through to a specific data centre. Delivered cost depends on the power contract, transmission and distribution charges, losses, tariffs and the cost of resilience at the chosen site."
canonical_url: "https://data-centers-254.vercel.app/articles/ethiopia-power-exports-kenya-data-centres"
---
...
## The connection is a grid link, not a private data-centre feed
...
![Map of the 500 kV transmission line route from southern Ethiopia through Moyale to Suswa in Kenya](/images/ethiopia-kenya-500kv-route-map.webp)
...
![Diagram showing the power chain from electricity grid to GPU rack](/images/diagram-power-chain-grid-to-gpu.webp)
...
![Server racks inside a Nairobi data centre hall](/images/atlancis-nairobi-datacentre-hall.webp)
...
![Schematic of a grid connection from a high-voltage substation through switchgear and transformers to a data centre](/images/diagram-grid-connection-anatomy.webp)
...
![The Grand Ethiopian Renaissance Dam on the Blue Nile photographed at dusk](/images/gerd-dam-dusk.webp)
...
For more context on the domestic generation advantage, read our guide to [why geothermal energy matters to Kenyan data centres](/articles/geothermal-energy-kenya-data-centres).
...
![Capacitor stacks and valve equipment at the Suswa HVDC converter station in Kenya](/images/suswa-hvdc-converter-station.webp)
...
A customer buying colocation should therefore judge the facility, not only the national grid. Ask what happens when a utility feed fails, how long the UPS bridge lasts, when generators were last tested under load, how long on-site fuel lasts, and whether the two power paths are genuinely independent. Our explainer on [how data-centre UPS backup power works](/articles/ups-backup-power-kenyan-data-centres) covers the handover between a grid disturbance and generator power.
...
![A corridor of high-voltage transmission towers running through hills toward the Ethiopian border](/images/ethiopia-kenya-power-line-corridor.webp)
...
![Engineers operating switchgear inside the GERD powerhouse beneath a large Ethiopian flag](/images/gerd-powerhouse-ethiopian-flag.webp)
...
![Schematic of a data centre microgrid combining grid supply, on-site generation and battery storage](/images/diagram-datacentre-power-microgrid.webp)
