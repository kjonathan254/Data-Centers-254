...
secondary_keywords:
  - "green data centre Kenya"
  - "renewables overtake coal 2026"
  - "IEA renewable electricity forecast"
...
images:
  - src: "/images/kenya-geothermal-plant-olkaria.webp"
    alt: "Steam pipelines and cooling towers at the Olkaria geothermal complex in Naivasha"
    caption: "Olkaria's geothermal fields give Kenya something few data centre markets have: round-the-clock renewable baseload power"
    position: "hero"
  - src: "/images/kenya-transmission-pylons-2.webp"
    alt: "High-voltage transmission pylons crossing Kenyan terrain"
    caption: "The next policy question is where Kenya's renewable electrons create the most value: factories, EV plants, or data halls"
    position: "section-break"
  - src: "/images/kenya-wind-turbines-wide.webp"
    alt: "Wind turbines turning across a Kenyan landscape"
    caption: "Wind, hydro, solar and geothermal together supply more than 90 percent of Kenya's electricity"
    position: "inline"
  - src: "/images/kenya-solar-farm-2.webp"
    alt: "Rows of photovoltaic panels at a Kenyan solar farm"
    caption: "Expanding solar capacity rounds out Kenya's renewable mix, though geothermal remains the baseload backbone data centres rely on"
    position: "inline"
internal_links:
  - text: "geothermal energy powering Kenya's data centres"
    href: "/articles/geothermal-energy-kenya-data-centres"
  - text: "solar power for Kenyan data centres"
    href: "/articles/solar-power-data-centres-kenya"
  - text: "what Kenya Power tariffs mean for data centre operators"
...
external_sources:
  ...
  - title: "IEA, Renewables: electricity tracking"
    url: "https://www.iea.org/energy-system/renewables"
faq:
  - question: "Why does Kenya's renewable electricity matter for data centres?"
    answer: "More than 90 percent of Kenya's electricity comes from renewable sources, anchored by geothermal plants that run around the clock. That combination is rare: data centres can claim genuinely low-carbon operations from the grid mix itself, without the power purchase agreements, battery banks, or offset accounting that data centres in coal-heavy markets need to make similar claims. For hyperscalers with carbon-free energy pledges, that makes Kenya structurally attractive."
  - question: "What did the IEA say about renewables in 2026?"
    answer: "According to International Energy Agency data cited in recent commentary, renewable generation reached near parity with coal in 2025 and is forecast to overtake coal as the world's largest source of electricity in 2026, growing more than eight percent in the year. The IEA projects renewables' share of global generation to rise from 33 percent in 2025 to 37 percent by 2027, while global electricity demand grows 3.6 percent in 2026, driven by industry, electric vehicles, and expanding data centres."
  - question: "Could a data centre run directly on Kenya's geothermal fields?"
    answer: "Technically yes, and the idea keeps gaining relevance as AI training workloads decouple from big cities. A facility built at or near Olkaria could buy power close to generation cost, but Olkaria sits roughly 120km from Nairobi, which creates fibre latency and operations challenges. The trade-off is most acceptable for power-hungry, latency-tolerant workloads such as AI model training. Our geothermal explainer covers the economics in detail."
  - question: "Will Kenya's green industrial parks host data centres?"
    answer: "It is plausible and worth watching. Zones like the Sleeping Warrior Special Economic Zone at Elementaita are being designed around renewable power from the ground up, and the new Mombasa Industrial Park adds port-adjacent land with fibre routes to the submarine cables landing there. Data centres could anchor such parks as high-value tenants, but they will compete for the same electrons and the same incentives as export manufacturing, which is exactly the policy debate now opening up."
canonical_url: "https://data-centers-254.vercel.app/articles/kenya-renewables-industrial-power-data-centres"
---
...
![High-voltage transmission pylons crossing Kenyan terrain](/images/kenya-transmission-pylons-2.webp)
...
The honest answer is that data centres fit in three places, each with a different value proposition. The first is Nairobi, where the existing cluster, the operators catalogued in [our facility directory](/directory), sits on dense fibre, the KIXP peering point, and enterprise demand. The green-grid story strengthens Nairobi's hand in regional comparisons, giving Kenyan operators a marketing claim their counterparts in diesel-dependent markets cannot match, and it aligns neatly with the national ambition our [market outlook](/articles/kenya-data-centre-market-outlook-2025-2030) tracks.
