...
images:
  - src: "/images/dc-fibre-optics.webp"
    alt: "Fibre optic infrastructure on the new G2M route"
    caption: "2,000 kilometres of terrestrial fibre now connect Goma's data traffic to the Mombasa cable landing"
    position: "hero"
  - src: "/images/aerial-fibre-technician-utility-pole.webp"
    alt: "Fibre technician working on the terrestrial network"
    caption: "Terrestrial diversity is the unglamorous work that makes international bandwidth reliable"
    position: "section-break"
  - src: "/images/dc-networking.webp"
    alt: "Network interconnection equipment"
    caption: "Points of presence at data centres and internet exchanges turn a fibre route into usable capacity"
    position: "inline"
internal_links:
  - text: "Kenya infrastructure map"
    href: "/infrastructure/map"
  - text: "submarine cables landing in Kenya"
  ...
  - text: "Mombasa's data centre cluster"
    href: "/articles/why-data-centres-cluster-nairobi-mombasa"
external_sources:
  - title: "ITWeb Africa, Paratus Group puts East Africa connectivity in focus at ITW Africa 2026 (8 Sep 2026)"
    url: "https://itweb.africa/article/paratus-group-puts-east-africa-connectivity-in-focus-at-itw-africa-2026/kLgB1MezZ9Wq59N4"
  - title: "Paratus Group, official announcements"
    url: "https://www.paratus.africa/"
faq:
  - question: "What is the G2M fibre route?"
    answer: "The Goma-to-Mombasa (G2M) route is Paratus Group's roughly 2,000 km terrestrial fibre connection linking Goma in eastern DR Congo with the Kenyan coast via Kigali, Kampala and Nairobi. Paratus confirmed in September 2026 that the route is live and carrying traffic."
  - question: "Why does the G2M route matter for Kenya?"
    answer: "It gives landlocked and eastern DRC traffic a direct terrestrial path to the submarine cables landing at Mombasa, and gives Kenyan networks a new east-west diversity option. It also strengthens the case for Mombasa as a true cable-landing hub rather than a single-corridor endpoint."
  - question: "Who is Paratus Group?"
    answer: "Paratus is a pan-African telecommunications and network services provider expanding across southern, eastern and central Africa. In East Africa it operates the G2M route, points of presence in data centres and internet exchanges, and recently launched Starlink services in Uganda."
---
...
![Fibre optic infrastructure on the new G2M route](/images/dc-fibre-optics.webp)
...
![Fibre technician working on the terrestrial network](/images/aerial-fibre-technician-utility-pole.webp)

## The Kenyan angle: what it changes for data centres and buyers

For Kenya's data centre market, the G2M is quietly significant. Interconnection density, the metric we [track on every directory entry](/directory), grows when more networks can reach more buildings over more paths. A live east-west feeder means DRC, Rwandan and Ugandan networks have one more reason to place points of presence in Nairobi's carrier-neutral facilities and at Mombasa's coastal sites, rather than simply transiting. More networks present means more peering, lower latency for regional traffic, and better economics for the Kenyan businesses buying transit behind them.
