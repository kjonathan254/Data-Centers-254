...
meta_description: "23 of Kenya's 27 tracked data centres sit in two cities. The three forces behind the cluster: where cables land, where the grid is, where demand lives."
...
images:
  - src: "/images/mombasa-old-town-wide.webp"
    alt: "Mombasa old town, the coastal end of Kenya's data centre geography"
    caption: "Two cities, two logics: latency pulls one way, subsea cables pull the other"
    position: hero
...
internal_links:
  ...
  - text: "the DC Directory"
    href: "/directory"
  - text: "the Amaco Hercules proposal, explained"
...
external_sources:
  ...
  - title: "Business Daily, Inside Mombasa's rise as Kenya's key tech hub (Dennis Musau, 14 September 2026)"
...
faq:
  ...
  - question: "Does Mombasa's cable access make it a better data centre location than Nairobi?"
    answer: "Not by itself. Mombasa's advantage is proximity to the submarine cable landing stations, which matters most for international transit and content delivery. But the city hosts four of Kenya's tracked facilities, all of them transit or peering oriented, because the demand that fills data centres (enterprise IT, fintech, government workloads) sits in Nairobi, and Nairobi is already served by fibre routes that carry traffic to and from the coast. Mombasa is strategically important for connectivity and disaster-recovery sites, while Nairobi remains where capacity is actually consumed."
...
Ask where Kenya's data centres are and the honest answer is still essentially two words: Nairobi, Mombasa. The DC254 directory currently tracks 27 facilities across the country, and 23 of them sit in just two cities: 19 in Nairobi, including announced projects that have yet to break ground, and 4 in Mombasa, from iColo's MBA1 and MBA2 to Telkom Kenya's Telephone House and the SEACOM cable landing station. The four outside the pair are the government's Konza National Data Centre and three Nairobi-metro edge sites in Limuru, Ruiru, and Thika. No facility exists in Kisumu, Nakuru, Eldoret, or any of Kenya's other major towns. For a country of roughly 55 million people and an economy that runs on mobile money, that is a strikingly narrow geographic footprint, and it is not an accident.
...
## First, the facts: 27 facilities, two cities

Start with what the verified data actually shows. Of the 27 facilities in the DC254 directory, 19 are located in Nairobi County, from hyperscale halls along Mombasa Road like iXAfrica NBOX1 and the Africa Data Centres campus, to enterprise and telecom facilities in Westlands such as Safaricom's Waiyaki Way data centre, to smaller colocation rooms scattered through the industrial area. Four operate in Mombasa County: iColo's MBA1 in Miritini, MBA2 in Nyali, Telkom Kenya's Telephone House exchange, and the SEACOM cable landing station. The remaining four sit just outside the two-city frame: the government's Konza National Data Centre and three Nairobi-metro edge sites (Safaricom Red Hill in Limuru, Nxtra by Airtel at Tatu City, and Safaricom Thika). Disclosed operational IT load across the eight facilities that publish figures totals roughly 10.5 megawatts (DC254 database), modest by global standards, and almost entirely consumed within Nairobi's metropolitan economy; several operators do not disclose figures, so true installed capacity is higher.

Two clarifications matter before going further. First, "two cities" is still slightly generous to Mombasa: Nairobi holds the overwhelming majority of capacity, and Mombasa's four tracked facilities remain modest in scale, valued primarily for where they stand rather than how much they hold. Second, announced projects complicate the picture but do not change it. The Microsoft–G42 joint venture, nominally a $1 billion facility, remains at announcement stage and is expected to site near Nairobi or the Olkaria geothermal fields, either way, still within the same power-and-demand corridor this article describes.
...
This explains why Mombasa matters in the data centre story. iColo's MBA1 and MBA2, Telkom's Telephone House, and the SEACOM landing station exist primarily because of their location: peering, transit, and disaster-recovery sites near the landing stations, letting operators and carriers reach the cables directly without depending on the corridor to Nairobi. They are facilities whose value comes from geography rather than scale. The same logic explains why the landing stations themselves, which are technically small data facilities, cluster along a few kilometres of coast: the cables come ashore at specific beaches determined by the seabed route, and the buildings must follow.
...
The most concrete new test of that logic arrived in August 2026. Amaco Energy Group, a Greek multinational, announced a proposed $1.5 billion (Sh194 billion) AI data centre for Mombasa, with Dongo Kundu and Kilindini identified as candidate sites near the port and the Special Economic Zone, and GE Vernova engaged to supply gas turbines for the firm's Hercules power barge, an LNG-fired platform designed to generate electricity and handle cooling without depending on Kenya's national grid (Business Daily, September 14, 2026). The proposal matters precisely because it attacks the two forces that have always capped Mombasa: it would self-supply power rather than wait for the grid, and it bets on port-and-SEZ demand rather than Nairobi's enterprise base. It is still only a proposal, with no announced capacity, timeline, or government approval, but it is the first credible attempt to found a third force on the coast. We now track this proposal in its own article: [Amaco's Mombasa AI data centre, explained](/articles/amaco-hercules-mombasa-ai-data-centre), including the GE Vernova power barge agreement and the open questions.
