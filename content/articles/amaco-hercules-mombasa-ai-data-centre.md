...
secondary_keywords:
  - "Amaco Energy Group Kenya"
  - "Hercules power barge Mombasa"
  - "Dongo Kundu AI data centre"
  - "off-grid data centre Kenya"
  - "GE Vernova Amaco Kenya"
  - "Mombasa AI hub"
...
internal_links:
  ...
  - text: "the coast's busiest interconnection point, iColo MBA1"
    href: "/directory/icolo-mba1"
  - text: "the CA's proposed standalone data centre licence"
...
external_sources:
  ...
  - title: "Business Daily, Greek firm Amaco partners with US energy giant for Sh194bn Mombasa data centre (10 Sep 2026; GE Vernova cooperation, demand pipeline, Kabogo meeting, licensing context)"
    url: "https://www.businessdailyafrica.com/bd/corporate/technology/greek-firm-amaco-mombasa-data-centre-5590230"
  - title: "w.media, AMACO seeks approval for US$ 1.5 billion off-grid AI data center in Kenya (21 Aug 2026; Theodoropoulos Nairobi visit, May 2026 East Africa positioning, spokesperson statement)"
    url: "https://w.media/amaco-seeks-approval-for-us-1-5-billion-off-grid-ai-data-center-in-kenya"
  - title: "Construction Review Online, Project HERCULES: Amaco and GE Vernova Partner for $1.5B Off-Grid AI Data Centre in Mombasa (10 Sep 2026; 28-month build estimate, Mariakani surplus export, ARISE SEZ off-take, 2024 LNG origin)"
    url: "https://constructionreviewonline.com/project-hercules-amaco-and-ge-vernova-partner-for-1-5b-off-grid-ai-data-centre-in-mombasa"
  - title: "TechCabal (via edgeX), What AMACO's $1.5 Billion Kenya AI Project Can Teach Africa About Energy (20 Aug 2026; Kenya 2,439 MW record peak, 100 MW is about 4 percent of peak, IEA data centre electricity figures)"
    url: "https://pro.edgex.exchange/en-US/news/article/amaco-hercules-mombasa-ai-data-centre"
  - title: "Kenyans.co.ke, Greek Firm Plans Ksh 194B AI Data Centre in Mombasa (22 Aug 2026; surplus electricity to grid, Microsoft-G42 power dispute context)"
    url: "https://www.kenyans.co.ke/news/126411-greek-firm-plans-ksh-194b-ai-data-centre-mombasa"
  - title: "AMACO, Mombasa LNG to Power project page, registration ES00101/AMACO/2024 (fetched 15 Sep 2026; Kwale County siting, 6.2 mtpa regas capacity, permitting status)"
    url: "https://amaco.gr/from-amaco-greece-to-kenya-mombasa-lng-to-power"
faq:
  - question: "What is the Amaco Mombasa data centre project?"
    answer: "It is a proposed $1.5 billion (Sh194.2 billion) artificial intelligence data centre in Mombasa, announced by Greek energy firm Amaco Energy Group in August 2026 and developed under the name Project HERCULES. Its defining feature is that it would generate its own electricity from an LNG-fired floating power barge instead of buying power from Kenya's national grid. The project is at proposal stage: approvals, financing, customers and a final capacity figure have not been announced."
  - question: "Who is Amaco Energy Group?"
    answer: "Amaco Energy Group is a Greek multinational energy and infrastructure firm led by founder and chief executive Theodore Theodoropoulos, with offices in Greece and the United States. Its Kenyan project vehicle is AMACO Ltd (Kenya). The company registered an LNG-to-power project in Kenya in 2024 (reference ES00101/AMACO/2024), covering LNG delivery, storage and regasification at Kwale County near the Mombasa port, and the data centre proposal builds on that energy plan."
  ...
  - question: "When will the Amaco data centre be built?"
    answer: "Construction has not started and no official timeline has been published. Construction Review Online reported on 10 September 2026 that, if approved, the project is expected to take around 28 months to build, and Amaco's own LNG project page lists a start year of 2027 with the project in the permitting phase. Both figures are plans, not commitments, and the project still needs regulatory approval."
  - question: "Will it use Kenya's national grid?"
    answer: "No, the design is intentionally off-grid: the Hercules barge generates electricity for the data centre and its cooling directly. Amaco has said the system could contribute surplus power to Kenya's wider energy needs, and Construction Review Online reports a potential export path to the local grid near the Mariakani substation. That would be a bonus, not the core design."
canonical_url: "https://data-centers-254.vercel.app/articles/amaco-hercules-mombasa-ai-data-centre"
---
...
One housekeeping note: as of 15 September 2026, DC254 has not added this project to its directory count of 27 tracked facilities. A proposal without approval, financing, or a confirmed site does not yet meet the directory's verification bar, whatever the size of its headline number. [Kenya's data centre market in numbers](/articles/kenya-data-centre-market-numbers) tracks what has actually been built and disclosed, including the roughly 10.5 MW of operational IT load published by the eight facilities that disclose figures.
...
**The approvals.** The project is in the permitting phase, and the timing is notable: Kenya is mid-transition in how it regulates data centres, with the Communications Authority having placed them under the telecommunications licensing regime and now consulting on a [standalone data centre licence](/articles/kenya-ca-standalone-data-centre-licence) (Business Daily, 10 September 2026).

![Server racks inside an AI data centre hall](/images/whats-inside-ai-data-center-wide.webp)
