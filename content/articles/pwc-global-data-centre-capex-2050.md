---
title: "PwC's $31.6 Trillion Data Centre Forecast: Where Africa and Kenya Fit In"
...
secondary_keywords:
  ...
  - "data centre capex 2050"
  - "AI infrastructure investment"
  - "Africa data centre investment"
  - "Kenya renewable grid data centres"
  - "data sovereignty capex"
...
images:
  - src: "/images/dc-business-investment.webp"
    alt: "Investment planning for data centre capital expenditure"
    caption: "PwC projects global data centre capex climbing toward 2050 — here is what the numbers mean"
    position: hero
  - src: "/images/dc-gpu-cluster-2-wide.webp"
    alt: "Rows of GPU compute clusters inside a data centre"
    caption: "Every $1 of construction capex commits the market to roughly $12 of ICT equipment over the asset's life"
    position: "section-break"
  - src: "/images/kenya-solar-farm-2.webp"
    alt: "Solar panels at a Kenyan solar farm"
    caption: "PwC's analysis treats low-carbon power as a structural advantage — and Kenya's grid already leads the continent on it"
    position: "inline"
  - src: "/images/kenya-transmission-pylons.webp"
    alt: "High-voltage transmission pylons in Kenya"
    caption: "Speed to power decides who captures the capex: transmission queues now determine which projects break ground"
    position: "inline"
internal_links:
  - text: "Kenya's renewable energy advantage for data centres"
  ...
  - text: "geothermal energy powering Kenyan data centres"
    href: "/articles/geothermal-energy-kenya-data-centres"
  - text: "Kenya's power infrastructure constraints"
    href: "/articles/kenya-power-infrastructure-data-centres"
  - text: "why AI needs GPU-ready data centres"
...
external_sources:
  - title: "PwC — Where $31.6 trillion of capex flows in the era-defining AI build-out (data centre outlook, commissioned analysis by Oxford Economics)"
    url: "https://www.pwc.com/gx/en/1/services/consulting/technology/data-centre-outlook.html"
faq:
  - question: "What does PwC's $31.6 trillion figure actually measure?"
    answer: "It is PwC's central-scenario estimate of cumulative global data centre capital expenditure through 2050, modelled by Oxford Economics across 46 countries and territories in five regions. The figure covers both buildings and structures and the ICT equipment inside them — servers, storage, networking, CPUs, and GPUs — with equipment assumed to refresh every four to six years. The plausible range runs from about $22 trillion to nearly $50 trillion depending on the pace of AI adoption, and annual spending rises from roughly $800 billion in 2026 to $1.1 trillion in 2030 and $1.8 trillion in 2050."
  - question: "Why does PwC call Africa the lowest-risk capex story?"
    answer: "Because Africa is the only region in the forecast whose central scenario is not a bet on AI adoption. The continent is largely buying foundational digital infrastructure — cloud, storage, connectivity, and enterprise compute — that pays off under every AI scenario PwC modelled. That makes Africa's $255 billion cumulative capex through 2050 paradoxically low-risk: if AI accelerates, upside arrives; if adoption stalls, the foundational build continues anyway. South Africa anchors the region, with Kenya, Nigeria, and Ghana named among the most promising emerging markets."
  - question: "What is the sovereignty scenario and why does it favour Africa?"
    answer: "PwC modelled a scenario in which governments and regulated industries stop relying on foreign infrastructure for critical workloads — public services, financial systems, healthcare, and sovereign AI — while non-critical workloads keep moving freely. Global capex barely moves, falling just 6.7 percent, but the geography redistributes: Africa records the largest proportional uplift of any region, with cumulative capex rising roughly 12 percent from about $255 billion to $284 billion, supported by onshoring of cloud storage and a developing AI market. It is one of the few scenarios in which Africa is a net winner."
  - question: "What makes Kenya's position distinctive in the forecast?"
    answer: "PwC singles out Kenya's power grid as approximately 95 percent renewable, making it one of the most sustainably powered data centre markets in the world — a structural advantage as low-carbon build-out shifts from marketing language to siting criterion. Combined with the country's position as one of Africa's most promising emerging data centre markets, that grid mix positions Kenya for exactly the workloads — sovereign inference, enterprise cloud, carbon-conscious capacity — that the sovereignty and sustainability trends reward, provided grid connection capacity keeps pace with demand."
canonical_url: "https://data-centers-254.vercel.app/articles/pwc-global-data-centre-capex-2050"
---
...
![Rows of GPU compute clusters inside a data centre](/images/dc-gpu-cluster-2-wide.webp)
