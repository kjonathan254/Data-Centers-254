...
secondary_keywords:
  ...
  - "prepaid fibre South Africa Kenya"
  - "Kenya fixed broadband subscriptions 2025"
...
internal_links:
  ...
  - text: "the submarine cables landing at Mombasa"
    href: "/articles/submarine-cables-landing-mombasa"
  - text: "KIXP and why Kenya's internet exchange matters"
    href: "/articles/kixp-internet-exchange-point-kenya"
  - text: "data centre interconnection and peering in Kenya"
...
external_sources:
  ...
  - title: "GSMA — The Mobile Economy Africa 2026 ($240bn contribution in 2025)"
    url: "https://www.gsma.com/mobileeconomy/africa/"
  - title: "Africa Finance Corporation / WIOCC — $300m infrastructure investment (1 September 2026)"
    url: "https://www.africafinancecorporation.com/"
  - title: "Communications Authority of Kenya — sector statistics via Techpoint (2.14m fixed subscriptions, June 2025)"
    url: "https://techpoint.africa/2025/09/23/kenya-fixed-internet-subscribers/"
faq:
  - question: "What is a commercial operating model in fibre?"
    answer: "It is everything that turns a lit network into recurring revenue: a usable product catalogue, accurate coverage and pricing data, ordering and fulfilment workflows that partners can integrate with, service assurance, billing and settlement systems, and payment options that match how customers actually pay — monthly contracts in some markets, prepaid vouchers and mobile-money top-ups in others. A fibre network is not automatically a wholesale business; the commercial foundations have to be built deliberately, which is why operators that industrialise this layer convert coverage into take-up faster than those that treat it as an afterthought."
  - question: "Why is prepaid fibre growing in Africa?"
    answer: "Because monthly contracts assume a payment pattern many households do not have. Irregular incomes and cashflow constraints make day-long, weekly and monthly voucher models — already proven in South Africa's township markets through brands like Vox's Hypa — a practical route to first-time fibre adoption. Prepaid also fits the mobile-first habits shaped by M-Pesa-style digital payments in Kenya and across East Africa. Prepaid is not a universal model; it is evidence that product design, distribution and payments must flex to local demand for fibre take-up to widen beyond early adopters."
  - question: "How many fixed broadband subscriptions does Kenya have?"
    answer: "Kenya's Communications Authority counted about 2.14 million fixed-internet subscriptions by June 2025, led by Safaricom with roughly 678,000 lines (about 36.5 percent), followed by Jamii Telecommunications and Wananchi Group's Zuku. Analyses carried by TelcoTitans place the fibre-to-the-home subset at around 1.2 million lines by the same date — the balance rides on fixed-wireless access. Either way, penetration remains low relative to population, which is why Kenya is often cited as one of Africa's fastest-scaling fixed-broadband markets."
  - question: "What is open-access wholesale fibre?"
    answer: "A model in which the company that builds and operates the fibre network (the fibreco) sells capacity on wholesale terms to many retail internet service providers instead of serving end customers itself. The fibreco focuses on construction and network operations; ISPs compete on price, service and customer relationships over shared infrastructure. Done well, it improves capital efficiency, reduces duplicate trenches, and widens consumer choice — but it demands serious operational plumbing: partner onboarding, TM Forum-style open APIs, reliable product and availability data, and automated billing and settlement across dozens of partners."
canonical_url: "https://data-centers-254.vercel.app/articles/africa-fibre-commercial-operating-model"
---
