...
cluster: "Beginner"
og_image: "/images/nairobi-skyline.webp"
reading_time: "11 min"
images:
  - src: "/images/nairobi-skyline.webp"
    alt: "Nairobi's skyline at dusk, where Kenya's 5G rollout began"
    caption: "Every mobile generation has redrawn this skyline's connection to the world — 5G is the fifth redraw, and Kenya was East Africa's first commercial market"
    position: "hero"
  - src: "/images/dc-networking.webp"
    alt: "Labelled diagram of a fibre patch panel with connector types"
    caption: "Behind every 'G' sits the same unglamorous truth: fibre. This labelled patch-panel diagram is the kind of physical infrastructure that carries each generation's traffic between towers and data centres"
    position: "diagram"
internal_links:
  - text: "how 5G drives data centre demand in Kenya"
  ...
  - text: "Kenya internet speeds explained"
    href: "/articles/kenya-internet-speeds-data-centres"
external_sources:
  - title: "Reuters — Safaricom launches Kenya's first 4G Internet services (4 December 2014)"
    url: "https://www.reuters.com"
  - title: "Reuters — Kenya's Safaricom targets more fixed internet users with 5G launch (27 October 2022)"
    url: "https://www.reuters.com"
  - title: "Safaricom — Launches Most Advanced 4G Network in Africa (press release, 4 December 2014; notes first mobile data 2003 and first 3G platform in 2008)"
    url: "https://www.safaricom.co.ke"
  - title: "Safaricom — Announces Commercial Launch of 5G Services (October 2022; trials first announced March 2021)"
    url: "https://www.safaricom.co.ke"
  - title: "Airtel Kenya — 5G rollout (commercial launch 6 July 2023, 372 initial sites)"
    url: "https://www.airtelkenya.com"
  - title: "ITU — Recommendation ITU-R M.2160, framework and objectives of IMT-2030 (6G), approved November 2023"
    url: "https://www.itu.int"
faq:
  - question: "What is 5G in simple terms?"
    answer: "5G is the fifth generation of mobile network technology — the system your phone uses to talk to masts instead of using cables. Each generation replaced the last: 1G carried analogue voice, 2G added texts, 3G added mobile internet, 4G made smartphones fast, and 5G is designed around three things at once: very fast speeds (hundreds of Mbps to multi-Gbps), very low delay (as little as a few milliseconds), and very many connected devices per area (up to one million per square kilometre in theory)."
  - question: "When did Kenya get 5G?"
    answer: "Safaricom announced Kenya's first 5G trials in March 2021 and commercially launched 5G on 27 October 2022 — the first commercial 5G service in East Africa, starting in parts of Nairobi, Mombasa and Kisumu. Airtel Kenya followed as the country's second operator with its commercial launch on 6 July 2023, starting with 372 sites."
  - question: "What is the difference between 4G and 5G?"
    answer: "The headline difference is speed, but the deeper differences are latency and density. 4G typically delivers 15-30 Mbps with response times around 30-50 milliseconds; 5G can deliver hundreds of Mbps to multi-Gbps with response times that can drop to single milliseconds, and it can connect roughly 100 times more devices per square kilometre. That latency and device density — not just speed — is what enables new uses like factory automation, real-time remote monitoring, and fixed wireless home internet."
  - question: "What is 6G and when is it coming?"
    answer: "6G is the expected sixth generation of mobile networks. The ITU approved its official framework — Recommendation ITU-R M.2160, known as IMT-2030 — in November 2023, and standards work is under way with commercial networks realistically expected around 2030. Candidate capabilities include AI-native network operation, integrated sensing and communication, and much higher frequencies, but all of it is prediction, not product: no 6G network exists today."
  - question: "Does 5G replace fibre?"
    answer: "No — 5G depends on fibre. Nearly every 5G mast is backhauled by fibre-optic cable, and the data centres, internet exchanges and submarine cable landing stations that carry 5G traffic are all fibre-based. 5G replaces the last wireless hop between a mast and your device; everything behind that mast still rides on fibre. That is why every new mobile generation in Kenya has been accompanied by more fibre construction, not less."
canonical_url: "https://data-centers-254.vercel.app/articles/what-is-5g-1g-to-6g-history"
---
...
**For the data centre industry** — the reason this site watches 5G so closely — the effect is architectural. 5G's latency promises physically cannot be kept by sending every packet to a distant server: light itself needs about 5 milliseconds to travel 1,000 kilometres through fibre and back. Keeping response times in single milliseconds forces compute capacity out of a few large central facilities and into many small ones near the users — Multi-Access Edge Computing, or MEC. Each MEC node is, functionally, a small data centre with real power, cooling, and security requirements. 5G does not replace the big facilities either; every 5G mast still backhauls over fibre, and the traffic it generates ultimately pools in core data centres, internet exchanges, and the submarine cable landing stations around Mombasa. Our detailed analysis of [how 5G drives data centre demand in Kenya](/articles/5g-networks-data-centre-demand-kenya) puts numbers on that effect — hundreds of projected edge nodes nationwide — and it is the single strongest structural link between a telecom generation and Kenya's facility build-out.

![Labelled diagram of a fibre patch panel with connector types](/images/dc-networking.webp)
