---
title: "Starting a Data Centre Business in Kenya: Investment, Licensing, and Market Entry"
...
secondary_keywords:
  ...
  - "how to build a data centre Kenya"
  - "data centre business plan Kenya"
  - "colocation business Kenya"
  - "data centre licensing requirements"
...
internal_links:
  ...
  - text: "data centre directory"
    href: "/directory"
external_sources:
  - title: "Communications Authority of Kenya - Licensing"
    url: "https://www.ca.go.ke/category/licensing/"
  - title: "Kenya Investment Authority (KenInvest)"
    url: "https://www.investmentkenya.com/"
faq:
  - question: "How much does it cost to build a data centre in Kenya?"
    answer: "A small colocation facility (1-2MW IT load) typically requires KES 500 million to 1 billion ($3-7 million) in capital investment. A mid-sized facility (3-5MW) requires KES 1.5-3 billion ($10-20 million). A large hyperscale-class facility (10MW+) requires KES 5 billion+ ($35 million+). These figures include land, building construction, power infrastructure, cooling systems, fire suppression, and initial fit-out, but not the land cost which varies enormously by location."
  - question: "What licences do I need to operate a data centre in Kenya?"
    answer: "You need an NFP-T2 licence from the Communications Authority of Kenya (KES 15 million, 15-year term). You also need county government approvals for construction, environmental impact assessment (NEMA), fire safety certificates, and building approvals. If you plan to offer connectivity services, you may also need an ECS or ECNS licence from the CA."
  - question: "How long does it take to build a data centre in Kenya?"
    answer: "From concept to operational, a typical colocation data centre in Kenya takes 18-36 months. This includes 3-6 months for feasibility and design, 6-12 months for permitting and construction, 3-6 months for equipment installation and commissioning, and 3-6 months for certification, testing, and initial customer onboarding. The construction phase can be faster if using a modular or pre-fabricated approach."
...
![Data centre business investment and planning](/images/dc-business-investment.png)
...
![Data centre facility under development in Nairobi](/images/hero-dc-nairobi.png)
...
| Facility Size | IT Load | Construction | Land | Working Capital | Total |
|--------------|---------|-------------|------|-----------------|-------|
| Small | 1-2 MW | KES 300-600M | KES 50-200M | KES 100-150M | KES 450-950M |
| Medium | 3-5 MW | KES 800M-1.5B | KES 100-400M | KES 150-300M | KES 1-2.2B |
| Large | 10+ MW | KES 3-5B+ | KES 200-1B | KES 300-500M | KES 3.5-6.5B+ |

## Regulatory Requirements

### Communications Authority Licence

The [NFP-T2 licence](/articles/kenya-data-centre-licensing-framework) from the Communications Authority of Kenya is the primary regulatory requirement. The licence costs KES 15 million for a 15-year term and requires the operator to meet specific technical and operational standards. The application process involves submitting technical plans, financial statements, and evidence of compliance with CA requirements.
...
![Power infrastructure for a new data centre](/images/dc-power-systems.webp)
...
As discussed in [our Data Protection Act guide](/articles/kenya-data-protection-act-data-centres), data centre operators must register as data processors with the Office of the Data Protection Commissioner (ODPC). This is a straightforward process but should be completed before commercial operations begin.
...
![Regulatory and licensing requirements](/images/dc-policy-regulation.png)
