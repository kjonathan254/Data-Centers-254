---
title: "Bypassing the Red Sea: Berbera's Backup Route for Kenya"
slug: "berbera-northern-route-kenya-fibre-redundancy"
meta_description: "Somcable lands 2Africa and PEACE at Berbera and is building terrestrial routes into Ethiopia and South Sudan. What a northern alternative means for Kenya's cable risk."
primary_keyword: "submarine cable redundancy kenya"
secondary_keywords:
  - "berbera cable landing somaliland"
  - "east africa terrestrial fibre routes"
  - "mombasa subsea cable landing stations"
  - "red sea cable cut impact kenya"
  - "somcable northern route"
...
images:
  - src: "/images/mombasa-cable-landing-3.webp"
    alt: "Submarine cable landing station buildings on the East African coast"
  ...
  - src: "/images/amaco-cable-landing-beach.webp"
    alt: "Cable landing beach on the Kenyan coast where submarine fibre comes ashore"
    caption: "Every cable Kenya depends on comes ashore at a handful of beaches like this one, resilience planning starts at the water's edge"
    position: "inline"
internal_links:
  - text: "Submarine cables landing in Mombasa"
    href: "/articles/submarine-cables-landing-mombasa"
  - text: "Fibre networks powering Kenya's data centres"
    href: "/articles/fibre-optic-networks-kenya-data-centres"
  - text: "Kenya internet speeds and what they mean for data centres"
    href: "/articles/kenya-internet-speeds-data-centres"
  - text: "iXAfrica and operations in Kenya"
...
faq:
  ...
  - question: "What is the Northern Route?"
    answer: "The Northern Route is the emerging fibre path that runs through the Horn of Africa rather than around the coast. Somaliland's Somcable lands the 2Africa and PEACE cables at Berbera and is integrating them with a terrestrial backbone reaching into Ethiopia, with extensions toward South Sudan, the company said during ITW and Datacloud Africa 2026 in Nairobi. The idea is to give landlocked markets and regional traffic a second, physically diverse gateway alongside Mombasa."
  - question: "What happens to Kenyan internet when a Red Sea cable is cut?"
    answer: "Traffic that normally rides the affected system is rerouted over the remaining cables, which is automatic but not painless: capacity shrinks, congestion rises and speeds drop until repairs are done, which is what Kenya experienced during recent Red Sea disruptions reported at ITW Nairobi 2026. This is why operators buy capacity across multiple cable systems and why physically diverse routes (different seas, different landing points, different terrestrial paths) are the core of serious redundancy planning."
  - question: "Is Berbera a threat to Mombasa's gateway status?"
    answer: "It is better read as competition for specific traffic than a replacement. Mombasa has seven live systems, a mature landing-station ecosystem and the fibre corridors into Nairobi where Kenya's data centres sit, advantages Berbera cannot replicate quickly. Berbera's edge is geography for landlocked markets (Ethiopia and South Sudan) and a second physical gateway for regional traffic. For Kenya, a stronger Berbera is mostly upside: it adds a diverse route the region can fall back on."
canonical_url: "https://data-centers-254.vercel.app/articles/berbera-northern-route-kenya-fibre-redundancy"
---
