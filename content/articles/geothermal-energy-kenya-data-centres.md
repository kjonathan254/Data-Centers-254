---
title: "Geothermal Energy Powering Kenya's Data Centres: The Rift Valley Advantage"
...
secondary_keywords:
  ...
  - "Rift Valley geothermal data centres"
  - "green data centre Kenya"
  - "Kenya Power geothermal"
...
faq:
  ...
  - question: "Could a data centre be built directly at a geothermal field?"
    answer: "Technically yes, and this has been discussed. A data centre built at or near the Olkaria geothermal complex could potentially access power at generation cost, bypassing transmission losses and some distribution charges. However, Olkaria is 120km from Nairobi, which creates connectivity challenges. The concept is most viable for large facilities with specific use cases (like AI training that needs massive, cheap power) where the connectivity trade-off is acceptable."
  - question: "How does Kenya's geothermal compare to Iceland's?"
    answer: "Iceland generates approximately 25% of its electricity from geothermal (the rest is hydro) and is famous for attracting data centres with its cheap, clean power. Kenya's geothermal resource is larger in absolute terms and has greater growth potential. Both countries sit on the Great Rift Valley system. Kenya's advantage over Iceland is a much larger domestic and regional market for data centre services, while Iceland's advantage is decades more development experience and colder climate for free cooling."
canonical_url: "https://datacentre254.com/articles/geothermal-energy-kenya-data-centres"
---
