...
secondary_keywords:
  ...
  - "CA Kenya licensing consultation 2026"
...
images:
  - src: "/images/national-assembly-chamber-session.webp"
    ...
    caption: "The consultation runs on powers Parliament gave the Communications Authority — a standalone Data Centre licence is now formally on the table (photo in session, National Assembly)"
    position: "hero"
  - src: "/images/nairobi-westlands.webp"
    alt: "Westlands commercial district in Nairobi"
    caption: "The operators the new licence would cover are concentrated along Nairobi's Mombasa Road and Karen corridors"
    position: "section-break"
  - src: "/images/ups-switchgear-power-room.webp"
    alt: "UPS and switchgear line-up in a data centre power room"
    caption: "The proposed licence recognises what facilities actually provide — colocation, power, cooling, storage and computing — not telecom services to end users"
    position: "inline"
internal_links:
  - text: "Kenya's data centre licensing framework explained"
...
external_sources:
  ...
  - title: "Business Daily — CA to issue standalone permits for data centres in revised framework (8 Sep 2026)"
    url: "https://www.businessdailyafrica.com/bd/economy/ca-to-issue-standalone-permits-for-data-centres-5588294"
  - title: "Communications Authority of Kenya — Open Consultations"
    url: "https://www.ca.go.ke/open-consultations"
  - title: "TechAfrica News — Kenya proposes standalone licence framework for data centres (8 Sep 2026)"
