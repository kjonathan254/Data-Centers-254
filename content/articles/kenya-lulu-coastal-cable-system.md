...
meta_description: "The LuLu sea cable: a 500km coastal route from Mombasa to Lamu with five landing points and 144 fibre pairs. What is confirmed, and why it matters."
primary_keyword: "LuLu cable Kenya"
secondary_keywords:
  - "LuLu submarine cable system"
  - "Kenya coastal cable Mombasa Lamu"
  - "IOX cable Kenya"
...
images:
  - src: "/images/kenya-coast-beach.webp"
    alt: "The Kenyan Indian Ocean coastline where the planned LuLu cable would run"
    caption: "The LuLu system would run roughly 500km along exactly this corridor, the Kenyan coast between Mombasa and Lamu (announced September 2026)"
    position: "hero"
  - src: "/images/mombasa-cable-landing-2.webp"
    alt: "Submarine cable landing infrastructure on the Kenyan coast"
    caption: "Kenya's international cables concentrate on a short stretch of Mombasa shoreline, LuLu's pitch is spreading that landing risk along 500km of coast"
    position: "section-break"
  - src: "/images/fibre-handhole-duct-cables.webp"
    alt: "Fibre optic cables in a terrestrial handhole and duct network"
    caption: "LuLu is designed as a dual-path system, each subsea span pairs with a protected terrestrial route, so a single anchor drag or road works incident does not take the corridor down"
    position: "inline"
internal_links:
...
external_sources:
  - title: "SubTel Forum, LuLu Cable System Launches on Kenya's Coast (9 Sep 2026)"
    url: "https://subtelforum.com/lulu-cable-system-launches-on-kenya-s-coast/"
  - title: "Developing Telecoms, New coastal cable system planned for Kenya (9 Sep 2026)"
    url: "https://developingtelecoms.com/telecom-technology/data-centres-networks/"
  - title: "African Media Agency, INDOI (IOX), Blue Trade Investments and partners launch LuLu Cable System at ITW Africa 2026"
    url: "https://africanmediaagency.com/indoi-ltd-iox-blue-trade-investments-limited-and-partners-launch-lulu-cable-system-at-itw-africa-2026/"
faq:
  - question: "What is the LuLu cable system in Kenya?"
    answer: "LuLu is a planned coastal submarine cable system announced at ITW Africa 2026 (September 2026). It would run about 500km along Kenya's Indian Ocean shoreline between Mombasa and Lamu, with five identified landing points: Mombasa, Vipingo Special Economic Zone, Kilifi, Malindi and Lamu. It is distinct from the international cables that land in Mombasa, LuLu is a coastal diversity system connecting Kenyan locations to each other and to the international landing stations."
  - question: "Who is building the LuLu cable?"
    answer: "The consortium announced at ITW Africa 2026 comprises INDOI Ltd. (IOX) as developer, owner and commercial operator; Blue Trade Investments Limited as the Kenyan landing party, regulatory interface and delivery partner; plus ARISE IIP, AfriTrade Consulting Group and Kingdom Bank. No system supplier has been named and no supply or construction contracts have been announced as of September 2026."
  - question: "When will the LuLu cable be ready for service?"
    answer: "The stated target is readiness for service in Q2 2028, but that date is subject to contract execution. As of the September 2026 announcement, no construction start, route survey schedule or completed supply contracts had been disclosed, so the Q2 2028 date should be treated as a target, not a committed in-service date."
canonical_url: "https://data-centers-254.vercel.app/articles/kenya-lulu-coastal-cable-system"
---
...
What LuLu does not do is add international capacity. Kenya's trans-ocean connectivity still rides on the eight systems at Mombasa, and the country's bandwidth economics will keep being set by those systems and their owners. For the authoritative count and history of the international cables, see our full explainer on the [submarine cables landing in Mombasa](/articles/submarine-cables-landing-mombasa), and for how landing stations connect to facilities inland, read about [data centre interconnection and peering in Kenya](/articles/data-centre-interconnection-peering-kenya).
