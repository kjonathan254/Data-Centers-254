...
meta_description: "Edge computing places smaller facilities closer to end users, cutting latency for real-time apps. How the edge is emerging in East Africa and Kenya."
...
images:
  ...
  - src: "/images/diagram-tower-installation-rru-aau.webp"
    alt:  "Diagram of AAU and RRU equipment on a telecom pole"
...
![Diagram of AAU and RRU equipment on a telecom pole](/images/diagram-tower-installation-rru-aau.webp)
...
Latency is the reason edge matters, and our guide to [reducing cloud latency for users in Kenya](/articles/reduce-cloud-latency-kenya) shows how CDNs, the AWS Local Zone in Nairobi and local hosting shorten the round trip in practice.